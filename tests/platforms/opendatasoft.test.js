import { crawl, crawlAll, __RewireAPI__ as ToDosRewireAPI } from '../../src/platforms/opendatasoft';
...
describe('OpenDataSoft metadata crawler', function() {
  ...
  it('crawl() should return a list of valid dataset metadata.', () => {
    return crawl('https://data.opendatasoft.com/api/v2/catalog/datasets?rows=1&start=0')
      .then(results => {
  ...
  it('crawlAll() should return an array of Promise tasks', () => {
    ToDosRewireAPI.__Rewire__('crawl', () => Promise.resolve([]));
